            ...
            if "deposit" not in i:
                ...
                if int(datess.seconds / 60) >= 30:
                    ...
                    if int(i['use_point']) > 0:
                        ...
                        push_Message(i['UserId'],f'Point Back{i["use_point"]}ขออภัยค่ะคุณลูกค้าหลังจาก 30 นาทีของการสั่งอาหาร รายการจะถูกยกเลิกอัตโนมัติเพราะลูกค้าโอนเงินล่าช้า กรุณาเลือกสั่งรายการอาหารใหม่อีกครั้งค่ะ🙏')
                    else:
